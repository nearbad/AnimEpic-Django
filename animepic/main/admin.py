...
class CharacterAdmin(admin.ModelAdmin):
    ...
    def get_html_photo(self, object):
        if object.photo:
            return mark_safe(f"<img src='{object.photo.url}' width=50>") # mark_safe - не экранирует символы, функция возвращает юрл адрес фотки, и вместо пути в админ-панели будут отабражаться маленькие миниатюры
